...
export default function Hero4() {
  ...
  // ----- SHORT FORM STATES -----
  const [adult, setAdult] = useState("1"); // default 1
  const [child, setChild] = useState("0"); // default 0
  ...
  const handleSubmitModal = async (e) => {
    ...
    if (!consent) {
      toast.error("Please check the consent box before submitting.");
      return;
    }
    if (!selectedCountry) {
    ...
    try {
      await addDoc(collection(db, "customizedrequest"), payload);
  ...
  return (
    <section className="hero -type-4">
      ...
      <div className="hero__bg">
        <Image width={1920} height={860} src="/herosn.jpg" alt="background" />
      </div>
          ...
          <div className="col-xl-8 col-lg-9">
            ...
            >
              <div
                ...
                className="searchForm  -type-1 shadow-10 rounded-200"
              >
                        ...
                        <div style={{ position: "relative", width: "100%" }}>
                          <input
                            ...
                            style={{
                              ...
                              background: "transparent",
                              width: "100%",
                              // These properties ensure calendar icon visibility
                              appearance: "none",
                              WebkitAppearance: "none",
                              MozAppearance: "none",
                              paddingRight: "30px", // Space for the custom calendar icon
                            }}
                          />
                ...
                <div className="searchForm__button">
                  <button
                    ...
                    className="button -dark-1 size-180 bg-accent-1 rounded-200 text-white"
                  >
                    Start customizing
                  </button>
                </div>
      ...
      <Dialog
        ...
        maxWidth="md"
      >
        <DialogTitle>Request travel proposal</DialogTitle>
        <DialogContent>
          <Box
            component="form"
            id="proposalForm"
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6}>
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} label="Duration Range" required />
                  )}
                  sx={{ width: "100%" }}
                />
              </Grid>
              ...
              {/* Phone Number (with dial code automatically set by selectedCountry) */}
              <Grid item xs={12} md={4}>
                <TextField
                  label="Dial Code"
                  variant="outlined"
              ...
              <Grid item xs={12}>
                <FormControlLabel
                  ...
                  label="I hereby give permission to receive a travel proposal for a safari and/or beach vacation, as well as any other relevant news regarding my holiday."
                />
              </Grid>
            </Grid>
          </Box>
        ...
        <DialogActions>
          ...
          <Button form="proposalForm" type="submit" variant="contained">
