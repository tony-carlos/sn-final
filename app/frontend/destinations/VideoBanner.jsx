// app/frontend/destinations/VideoBanner.jsx
 ...
 */
function ModalVideoComponent({ isOpen, setIsOpen, videoId }) {
  return (
    <ModalVideo
      channel="youtube"
      isOpen={isOpen}
 ...
 * @param {Object} props - Component props
 * @param {string} props.videoId - YouTube video ID to embed
 * @param {string} [props.backgroundImage] - Background image URL (optional)
 * @param {string} [props.backgroundColor] - Background color (optional)
 * @returns {JSX.Element} - Rendered video banner with modal
 */
export default function VideoBanner({ videoId, backgroundImage, backgroundColor,  }) {
        ...
        >
          <div className="video__bg">
            <Image
              width={1290}
              height={250}
              src="/tz.jpg" // Ensure this path is correct
              alt="Destination Video Background"
