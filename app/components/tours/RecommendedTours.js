...
export default function RecommendedTours() {
  ...
  const recommendedTours = tours
    .filter(
      (tour) =>
        tour.basicInfo.isRecommended === true ||
        tour.basicInfo.isRecommended === "true"
    )
    .sort((a, b) => {
  ...
  if (recommendedTours.length === 0) {
    console.warn("No recommended tours found.");
    return (
      <section className="recommended-tours-section py-8 bg-gray-100">
    ...
    <section className="recommended-tours-section py-8 bg-gray-100">
      <div className="container">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold">Hiking & Climbing Tours</h2>
